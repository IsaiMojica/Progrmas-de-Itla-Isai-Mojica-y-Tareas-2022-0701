...
/* Esta función se utiliza para localizar la provincia que tuvo el mayor registro de precipitación pluvial en los últimos 10 años. Escribe además el registro correspondiente. */
{
int I, K, J, EMAY = -1;
float ELLU = -1.0, SUM;
for (I=0; I<F; I++)
...
/* Esta función se utiliza para localizar la provincia que tuvo el menor registro de lluvias en el último año. Escribe además el registro correspondiente. */
{
int I, J, EMEN;
float ELLU = 1000, SUM;
for (I=0; I<F; I++)
