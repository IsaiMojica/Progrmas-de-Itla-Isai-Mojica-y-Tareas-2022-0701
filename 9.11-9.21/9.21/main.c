...
void F2(FILE *ap, FILE *c1, FILE *c2, FILE *c3, FILE *c4, FILE *c5) /* Esta función genera un archivo de los alumnos admitidos en cada una de las carreras de la universidad. */
{
alumno alu;
rewind(ap);
fread(&alu, sizeof(alumno), 1, ap);
